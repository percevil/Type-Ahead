...
// USING restcointries API for calling information
// METHOD #1 LETTING CODE FILTER THE COUNTRIES ARRAY
...
// METHOD #2 LETTING THE API FILTER OUT THE COUNTRIES ARRAY
zlFetch('https://restcountries.eu/rest/v2/all?fields=name')
  ...
  // playing around with filtering other arrays from API
  // .then(response => {
  //   const currencies = response.body.map(currencies => {
  ...
  // ^ this logs all the available information from the API
  .catch(error => console.log(error));
